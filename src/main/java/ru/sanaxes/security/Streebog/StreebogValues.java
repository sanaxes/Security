...
/**
 * Константы для вычисления хэш-функции
 */
public class StreebogValues {

    /**
     * Матрица А для L преобразования {@link StreebogHash#L(int[])}
     */
    ...
    /**
     * Таблица подставновок для S преобразования {@link StreebogHash#S(int[])}
     */
    public final static int[] sBox = {0xFC, 0xEE, 0xDD, 0x11, 0xCF, 0x6E, 0x31, 0x16, 0xFB, 0xC4, 0xFA, 0xDA, 0x23, 0xC5, 0x04, 0x4D,
    ...
    /**
     * Таблица подстановок для P преобразования {@link StreebogHash#P(int[])}
     */
    public final static int[] tBox = {0, 8, 16, 24, 32, 40, 48, 56,
    ...
    /**
     * Табица констант для функции форммирования временного ключа K {@link StreebogHash#KeySchedule(int[], int)}
     */
